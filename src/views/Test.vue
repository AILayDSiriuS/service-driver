<template>
  <div id="test-page">
    ...
    <div class="container">
      <div class="row first">
          ...
          <div class="test-frame">
            <div class="test-align">
              <div class="test-content">
                ...
                <div class="test-body">
                  <div>
                    <div class="inputItem form_radio" v-for="answer in currentQuestion.answers" :key="answer">
        ...
        <div class="col-2" v-if="!finishTest">
          <div class="test-side-panel">
            <KPI v-bind:time="time" v-bind:totalQuestions.sync="allQuestions.length" v-bind:currentQuestion.sync="questionNumber" v-if="kpiReady" />
          </div>
          <div class="test-side-panel">
      ...
      <div v-if="finishTest" class="col-12 test-frame">
        <div class="test-align">
          <div class="test-content">
            <div class="test-header">
              <h2>Тест завершен</h2>
